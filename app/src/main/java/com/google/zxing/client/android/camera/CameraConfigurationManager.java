...
public final class CameraConfigurationManager {
    ...
    private boolean softColorInvert = false;
    ...
    if (camera.getFacing() == CameraFacing.FRONT) {
      overrideRotationString = prefs.getString(PreferencesFragment.KEY_FORCE_CAMERA_ORIENTATION_FRONT, null);
    } else {
      overrideRotationString = prefs.getString(PreferencesFragment.KEY_FORCE_CAMERA_ORIENTATION, null);
    }
    ...
    public boolean isSoftColorInvert() {
        return softColorInvert;
    }
